                    ...
                    if (reader.HasRows)
                        while (reader.Read())
                        {
                            var artwork = new ArtWork
                            {
                                ...
                                ShippingCost = (float) reader.GetDecimal(reader.GetOrdinal("shipping_cost")),
                                MaterialCost = (float) reader.GetDecimal(reader.GetOrdinal("material_cost")),
                                SalePrice = (float) reader.GetDecimal(reader.GetOrdinal("sale_price")),
